          ...
          <div className="row w-100 mx-0">
            <div className="col-lg-12 mx-auto">
              <div className="auth-form-light text-left py-5 px-4 px-sm-5">
                <div className="brand-logo heading_signup">
                <h3>Ready To take a free trial ?</h3>
                 
                </div>
                
                <h6 className="font-weight-light heading_signup">Signing up is easy. It only takes a few steps</h6>
                <form className="pt-3">
